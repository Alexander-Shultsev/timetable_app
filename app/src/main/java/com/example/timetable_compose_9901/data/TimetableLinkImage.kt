...
object GroupArray {
    val course1 = arrayOf(
        "2781", "2791", "2792", "2911", "2912", "2913", "2921", "2922", "2951", "2952", "2953",
    ...
    val course4 = arrayOf("9901", "9903", "9911", "9921", "9931", "9941", "9951")
}
...
val g2781 = arrayOf(
    ...
    GroupItem("СР", R.drawable.c1_2781_wednesday),
    GroupItem("ЧТ", R.drawable.c1_2781_thursday),
...
val g2912 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c1_2912_saturday)
)
val g2913 = arrayOf(
...
val g2996 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c1_2996_saturday),
)
...
val g1911 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1911_saturday),
)
val g1912 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1912_saturday),
)
val g1921 = arrayOf(
...
val g1951 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1951_saturday)
)
val g1952 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1952_saturday),
)
val g1981 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1981_saturday),
)
val g1991 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1991_saturday)
)
val g1992 = arrayOf(
...
val g1994 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c2_1994_saturday),
)
...
val g0902 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c3_0902_saturday)
)
val g0911 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c3_0911_saturday),
)
val g0931 = arrayOf(
    GroupItem("ПН", R.drawable.c3_0931_monday),
    GroupItem("ВТ", R.drawable.c3_0931_tuesday),
    GroupItem("СР", R.drawable.c3_0931_wednesday),
    GroupItem("ЧТ", R.drawable.c3_0931_thursday),
    GroupItem("ПТ", R.drawable.c3_0931_friday),
    GroupItem("СБ", R.drawable.img_rest),
)
val g0932 = arrayOf(
...
val g0941 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c3_0941_saturday),
)
val g0951 = arrayOf(
...
val g9901 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c4_9901_saturday)
)
val g9903 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c4_9903_saturday),
)
val g9911 = arrayOf(
    ...
    GroupItem("СБ", R.drawable.c4_9911_saturday),
)
val g9921 = arrayOf(
